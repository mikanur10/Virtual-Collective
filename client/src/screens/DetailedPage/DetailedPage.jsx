    ...
    <UniversalLayout>
      <div>
        ...
        <div className="detail-container">
          <h3 className="detail-name">{event.name}</h3>
          <p className="descrip-title"><b>Event Description</b></p>
          <p className="detail-descrip">{event.description}</p>
          <p className="date-title"><b>{event.subCategory} Date & Time</b></p>
          <p className="detail-date">{event.date} @ {event.time}</p>
